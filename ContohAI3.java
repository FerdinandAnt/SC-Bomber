...
public class ContohAI3
{
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println(sementara.getJenis());
			if(!sementara.getJenis().equals("PLAYER") && !sementara.getJenis().equals("BOM")){
	...
	public static void kabur(Item tembok){
		// DLS deep 1 LOL + MD
		int tmpA = -1;
		int tmpKn = -1;
		int tmpKr = -1;
